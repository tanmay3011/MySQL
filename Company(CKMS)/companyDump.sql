...
CREATE TABLE `project_techs` (
  ...
  CONSTRAINT `project_techs_ibfk_1` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`),
  CONSTRAINT `project_techs_ibfk_2` FOREIGN KEY (`technology_id`) REFERENCES `technologies` (`id`)
...
-- Dump completed on 2014-07-17 16:56:05
